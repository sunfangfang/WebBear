...
;(function ($, window, document) {
    ...
    radialIndicator.defaults = {
        ...
        barBgColor: '#78aeff', //unfilled bar color
        barColor: '#78aeff', //filled bar color , can be a range also having different colors on different value like {0 : "#ccc", 50 : '#333', 100: '#000'}
